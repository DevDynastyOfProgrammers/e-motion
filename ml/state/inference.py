...
class StateDirector:
    ...
    def __init__(self, prototypes_path: str) -> None:
        self.classifier: AdvancedEmotionClassifier | None = None
    ...
    def predict(self, emotion_probs: dict[str, float], confidence: float = 1.0) -> StatePrediction:
        ...
        return StatePrediction(preset_name=preset_name, confidence=pred_conf, multipliers=final_multipliers)
