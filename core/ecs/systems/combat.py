...
from core.ecs.component import HealthComponent, TransformComponent, TagComponent, PlayerInputComponent, \
    AIComponent, ProjectileComponent, DamageOnCollisionComponent
...
class DamageSystem:
    ...
    def on_area_damage(self, event: ApplyAreaDamageEvent):
    ...
    def on_direct_damage(self, event: ApplyDirectDamageEvent):
