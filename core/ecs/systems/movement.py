...
from core.ecs.component import TransformComponent, PlayerInputComponent, AIComponent, ProjectileComponent
...
class MovementSystem:
    ...
    def on_player_move(self, event: PlayerMoveIntentEvent):
...
class EnemyChaseSystem:
    ...
    def update(self, entity_manager: EntityManager, player_transform: TransformComponent, delta_time: float):
