...
# ML Settings
EMOTION_MODEL_PATH: str = get_env_str('EMOTION_MODEL_PATH', 'weights/emotion_model.pth')
STATE_PROTOTYPES_PATH: str = get_env_str('STATE_PROTOTYPES_PATH', 'weights/director.npy')
